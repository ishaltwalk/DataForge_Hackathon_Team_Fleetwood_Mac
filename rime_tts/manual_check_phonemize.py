...
from rime_tts.phonemize import phonemize
...
def test_phonemize_basic():
    ...
    ref_path = save(synthesize("Rhyme", speaker="falcon"), "ref_rhyme.wav")
    check_wav(ref_path)
...
def test_round_trip(rpa: str):
    ...
    path = save(synthesize("", speaker="falcon", rpa=rpa), "round_trip.wav")
    check_wav(path)
